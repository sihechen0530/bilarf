...
def compute_data_loss(batch, renderings, config):
    ...
    # batch_rgb = batch['rgb']
    batch_rgb = conversion.convert(batch['rgb'], config, is_torch=True)

    for rendering in renderings:
        # rendering_rgb = rendering['rgb']
        rendering_rgb = conversion.convert(rendering['rgb'], config, is_torch=True)
